...
@section('icon-jenjang',asset('assets/images/SMA.png'))

@section('title')
Formulir Pendaftaran Peserta Didik Baru SMA Al Azhar Menganti Gresik
@endsection
...
<div class="row">
    <div class="col-md-12">
        ...
        <form method="POST" role="form" enctype="multipart/form-data">
            ...
            <div id="form">
                @include('siswa-sma.form2')
            </div>

            <div id="review" class="d-none">
                @include('siswa-sma.review')
            </div>
...
`
        ...
        <div class="form-group">
            ...
            ${$("[name=jurusan]").val() ? $("[name=jurusan]").val() : '-'}
        </div>
        `
