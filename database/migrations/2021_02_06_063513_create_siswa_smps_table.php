...
class CreateSiswaSmpsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('siswa_smps', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('kelas_pilihan_pertama');
            $table->string('kelas_pilihan_kedua');
    ...
    {
        Schema::dropIfExists('siswa_smps');
    }
}
